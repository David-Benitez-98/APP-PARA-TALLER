            ...
            <div id="page-wrapper">
                <div class="row">
                    <!--impresion del titulo de la pagina-->
                          <div class="col-lg-12">
                              <h3 class="page-header text-center"><strong>LISTADO DE NOTA DE CREDITO</strong>
                            <?php
                            ...
                            if (empty($aperturas)) {
                                ...
                                $timbrado = consultas::get_datos("select * from timbrado_2 where cod_tipo_comp = 2 AND  estado='ACTIVO'");
                                if (empty($timbrado)) {
                                    ?>
                            ...
                            <form action="nota_credito_factura_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="panel-body se">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 " >
                                            <label  class="control-label col-md-2"><h3>Funcionario:</h3></label>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <select class="form-control"  required="" name="vclie" id="detalles" >
                                                ...
                                                <?php foreach ($clientes as $cliente) { ?>
                                                    <option value="<?php echo $cliente['id_cliente_']; ?>"><?php echo $cliente['cliente']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
      ...
      <strong>  Desea Confirmar la Nota de Credito de la fecha'+ dat[1] + '</strong>');
        ...
        function proveedor() {
            ...
            if ((parseInt($('#facturaa').val()) > 0) || ($('#facturaa').val() === "") || ($('#facturaa').val() !== "")) {
                $.ajax({
                    type: "GET",
                    url: "/mauro/lista_cliente_credito.php?vfact=" + $('#facturaa').val(),
                    cache: false,
                    beforeSend: function () {
        ...
        function costo() {
            if (parseInt($('#facturaa').val()) > 0) {
                $.ajax({
                    type: "GET",
                    url: "/mauro/lista_montos_fact_cred.php?vfact=" + $('#facturaa').val(),
                    cache: false,
                    beforeSend: function () {
