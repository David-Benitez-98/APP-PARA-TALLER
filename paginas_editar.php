...
<div class="modal-header">
    ...
    <h4 class="modal-title custom_align" id="Heading">
        <strong><i>Editar permisos</i></strong></h4>
</div>
<div class="modal-body">
    <form action="paginas_control.php"
        ...
        <div class="panel-body se">
            ...
            <div class="form-group">
                <?php $paginas = consultas:: get_datos("select * from "
                        . "v_permisos where pag_cod=".$_REQUEST['vpag'].
                        " and gru_cod=" .$_REQUEST['vgru']) ?>
...
<?php require 'menu/js.ctp'; ?><!--Archivos JS Funcionalidades-->
