                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <h3 class="page-header">Registar Recepcion de Solicitud 
                            <a href="recepcion_servicio2_index.php" 
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class=" panel panel-success">
                            ...
                            <?php  $recepciones =  consultas::get_datos("select * from v_recepcion_2 where cod_recep=".$_REQUEST['codigo']);?>
                            <?php } ?>
                              
                                    <form action="recepcion2_servicio_control.php" method="post" 
                                    ...
                                    <input type="hidden" name="pagina" value="recepcion_servicio2_index.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php $clientes = consultas::get_datos("select * from v_clientes_2 "
                                                        . " order by id_cliente_2=".$recepciones[0]['id_cliente_2']." desc"); ?>  
                                            
                                        <?php } else { ?>
                                            <?php $clientes = consultas::get_datos("select * from v_clientes_2 "
                                                        . " order by id_cliente_2 desc"); ?>
                                        <?php }?>
                                            
                                            <select name="vcliente" id="vcliente" <?= !empty ($recepciones[0]['id_cliente_2']) ? 'disabled' : '' ?>
                                                    class="form-control">
                                                <?php
                                                if (!empty($clientes)) {
...
<!-- COMIENZO PARA EL DETALLE AQUI VA UNA TABLA PARA AGREGAR EL DETALLE-->
 <!-- /.col-lg-12 -->
                ...
                <?php  if (isset($_REQUEST['codigo'])) { ?>
                <?php  $detarecepciones =  consultas::get_datos("select * from v_deta_recep_2 where cod_recep=".$_REQUEST['codigo']);?>
                <?php } ?>
...
<!--                                        Aqui le falta la palabra al tr  clas="hidden-row"-->
                                        <tr class="hidden-row">
                                            <td>
                                                ...
                                                <input type="hidden" name="cod_vehiculo[]" id="cod_vehiculo">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input style="position: relative;top: 100%;left: 0px;z-index: 100;display: block;vertical-align: top;background-color: transparent;width: 700px;" type="text" required="" class="form-control buscar" name="product_name[]" 
                                                                   placeholder="Buscar por nombre, código" value="<?= isset($value['datos_vehiculo']) ? $value['datos_vehiculo'] : ''  ?>" readonly="">
                                                            <input type="hidden" name="cod_vehiculo[]" id="cod_vehiculo" value="<?= isset($value['cod_vehiculo']) ? $value['cod_vehiculo'] : ''  ?>">
                                                        </td>
                        ...
                        <div class="modal-content">
                            <div class="modal-header alert-success">
                                <button type="button" class="close" 
                                        data-dismiss="modal" arial-label="Close"></button>
                            ...
                            <form action="equipos_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                ...
                                <br>
                                 ...
                                 <!--Inicio Ciudad-->
                                    ...
                                    <div class="col-lg-4">
                                        <?php $marcas = consultas::get_datos("select * from marca_2 order by cod_mar"); ?>
          ...
          function typeaheadInit(el, url, defaultValue){
                $(el).typeahead(null, {
                    ...
                    templates: {
                        ...
                        suggestion: function (data) {
                            return '<p style="white-space:normal;margin-bottom:1px;">' + data.cod_vehiculo + "-" + data.datos_vehiculo + '</p>'
                        }
                    }
                }).bind("typeahead:selected", function (event, data) {
                        var exists = false;
                        $(event.currentTarget).parents('tr').find("[name='cod_vehiculo[]']").val(data.cod_vehiculo);
                        
                        $(".item-table [name='cod_vehiculo[]']").each(function(index, el){
                            if( $(el).val() == data.cod_vehiculo ){//pregunta dentro de un foreach si el producto se encuentra en la lista
                                exists = true;
                                return false;
                            }
                        });
                ...
                function grabar(){                  
                    ...
                    $('.item-table tbody tr:not(.hidden-row)').each(function (row, tr) {
                        var cod_vehiculo = $(tr).find("[name='cod_vehiculo[]']").val();
                        ...
                        if (cod_vehiculo !== ""&& observacion !== "" && observacion !== " " && observacion !== "  " && observacion !== "   " && observacion !== "    " && observacion !== "     " && observacion !== "     " && observacion !== "      " && observacion !== "'"  && estado_deta !== "") {
                            TableData[row] = {
                    ...
                    if (TableData.length !== 0) {
                        ...
                        $.ajax({
                            url: '/mauro/recepcion_servicio2_control.php',
                            type: "POST",
//                            dataType: 'json',
                            data: {
                                detalles: TableData,
                            ...
                            success: function(respuesta){
                                 ...
                                 setTimeout(function () {
                                        //  window.location.href = "./orden_compra_agregar.php";
                                          window.location.href = "./recepcion_servicio2_index.php";
                                      }, 3000);
