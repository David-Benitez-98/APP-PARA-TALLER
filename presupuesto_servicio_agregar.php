...
<!--                                                <th class="text-center">Acción</th>-->
                                            ...
                                            <tbody>
                                                <?php foreach ($detpresupuestoservicios as $detpresupuestoservicio) { ?> 
                                                    ...
                                                    <td class="text-center"><?php echo $detpresupuestoservicio['dat_vehi']; ?></td>
                                                    ...
                                                    <td class="text-center"><?php echo $detpresupuestoservicio['estado']; ?></td>
                                                     <td>
                                                        ...
                                                        $detpresupuestoservicio['dat_vehi'] . "_" .  
                                                        $_REQUEST ['vdiag']. "'"
                                                        ?>)"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                     ...
                                                     <a onclick="diag_confirma(<?php
                                                        echo "'" . $detdiagnostico['cod_diagnostico'] . "_" .$detdiagnostico['cod_vehiculo'] . "_" .
...
//                   calsubtotal();
            ...
            function deposito(){
                    if ((parseInt($('#artic').val()) > 0) || ($('#artic').val() !== "")) {
                        $.ajax({
                            type: "GET",
                            url: "/mauro/lista_deposito_compra2.php?varti=" + 
                                    $('#artic').val (),
                            cache: false,
                            beforeSend: function () {
                                $('#detalles').
                            html('<img src="/mauro/img/cargando.GIF">\n\
...
//                                        obtenerprecio();
                 ...
                 function obtenerprecioarti(){
                    if ((parseInt($('#artic').val()) > 0) || ($('#artic').val() !== "")) {
                        $.ajax({
                            type: "GET",
                            url: "/mauro/lista_precio_articulos.php?varti=" + 
                                    $('#artic').val (),
                            cache: false,
                            beforeSend: function () {
                                $('#deta_precio_arti').
...
//                                        calsubtotal();
                ...
                function obtenerprecioservi(){
                    if ((parseInt($('#tipo').val()) > 0) || ($('#tipo').val() !== "")) {
                        $.ajax({
                            type: "GET",
                            url: "/mauro/lista_precio_servicio.php?vtipo_servi=" + 
                                    $('#tipo').val (),
                            cache: false,
                            beforeSend: function () {
                                $('#deta_precio_servi').
