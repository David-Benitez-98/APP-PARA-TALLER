...
<!--                                        Campo Recepcion-->
                                ...
                                <div class="col-md-7">
                                    <?php $diagnosticos = consultas::get_datos("select * from v_recepcion_2 where estado='CONFIRMADO' order by cod_recep asc"); ?>
                                    <select name="vrecep" 
        ...
        <script>
            ...
            function anular(datos) {
                ...
                , 'diagnostico_servicio_control.php?vdiag=' + dat[0] +
                        ...
                        '&vcli=null'+
                        '&accion=2'+
                        '&pagina=diagnostico_servicio2_index.php');
            ...
            function cliente(){
                    if ((parseInt($('#recep').val()) > 0) || ($('#recep').val() !== "")) {
                        $.ajax({
                            type: "GET",
                            url: "/mauro/lista_cliente_recepcion.php?vrecep=" + 
                                    $('#recep').val (),
                            cache: false,
                            beforeSend: function () {
                                $('#deta_cliente').
