...
$pdf->AddPage('L', 'LEGAL');
//celda para titulo
$pdf->Cell(0, 0, "RECEPCION DE VEHICULO", 0, 1, 'C');
//SALTO DE LINEA
$pdf->Ln();
...
$ordentrabajos = consultas::get_datos("select * from v_recepcion_2 "
...
//           
        ...
        $detalles = consultas::get_datos("select * from v_deta_recep_2 "
        ...
        if (!empty($detalles)) {
            ...
            $pdf->Cell(190, 5, 'DATOS DEL VEHICULO', 1, 0, 'C', 1);
            $pdf->Cell(80, 5, 'OBSERVACION DEL VEHICULO', 1, 0, 'C', 1);
...
//            $pdf->Cell(30, 5, 'DESCUENTO', 1, 0, 'C', 1);
       ...
       $pdf->Cell(15, 5, $detalle['cod_vehiculo'], 1, 0, 'C', 1);
                $pdf->Cell(190, 5, $detalle['datos_vehiculo'], 1, 0, 'C', 1);
