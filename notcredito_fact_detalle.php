            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="panel-body">
                        ...
                        <?php if (isset($creditos[0]['cod_not_credi_vent'])) { ?>
                                            ...
                                            <?php foreach ($detafacts as $detafact) { ?> 
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?php echo $detafact['det_estado']; ?></td>
                                                        <td class="text-center">
                                                            <?php if ($credito['estado_nota'] == 'ACTIVO' && $detafact['cod_tipo_servi'] == NULL) { ?>  
                                                                <a onclick="notacredi(<?php
                                                                echo "'" . $detafact['cod_factura'] . "_" .
                                                                $detafact['dato_articulo'] . "_" .
                                                                $detafact['cod_dep'] . "_" .
                                                                $detafact['dep_descri'] . "_" .
                                                                $detafact['cod_art'] . "_" .
                                                                $detafact['cod_tipo_servi'] . "_" .
                                                                $detafact['descri_servicio'] . "_" .
                                                                $detafact['det_cantidad'] . "_" .
                                                                $detafact['det_precio_unit'] . "_" .
                                                                $detafact['monto_servicio'] . "_" .
                                                                $detafact['cod_vehiculo'] . "'";
                                                                ?>);" 
                                                                ...
                                                                echo "'" . $_REQUEST['vdetcred_fact'] . "_" .
                                                                $detafact['cod_art'] . "_" .
                                                                $detafact['cod_dep'] . "_" .
                                                                $detafact['det_precio_unit'] . "_" .
                                                                $detafact['det_cantidad'] . "_" .
                                                                $detafact['det_subtotal'] . "_" .
                                                                $detafact['det_estado'] . "_" .
                                                                $detafact['cod_tipo_servi'] . "_" .
                                                                $detafact['monto_servicio'] . "_" .
                                                                $detafact['cod_vehiculo'] . "_" .
                                                                $_REQUEST ['vfact'] . "'"
                                                                ?>)"
                                                                   class="btn btn-xs btn-warning" rel='tooltip' data-title="DESCARTAR DEVOLUCION"
                                                                   data-toggle="modal"
                                                                   data-target="#delete">
                                                                    <span class="glyphicon glyphicon-asterisk"></span></a>


                                                            <?php } else if ($credito['estado_nota'] == 'ACTIVO' && $detafact['cod_tipo_servi'] != NULL) { ?>
