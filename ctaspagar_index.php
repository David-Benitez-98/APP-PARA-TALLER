        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header">LISTADO DE CUENTAS A PAGAR
...
<!--                                                    <th class="text-center">Acciones</th>-->
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($ctas_pagar as $cta_pagar) { ?> 
                                                    <tr>
                                                        <td class="text-center"><?php echo $cta_pagar['cod_ctas_pagar']; ?></td>
                                                        <td class="text-center"><?php echo $cta_pagar['cod_compra']; ?></td>
                                                        <td class="text-center"><?php echo $cta_pagar['fecha_compra']; ?></td>
                                                        <td class="text-center"><?php echo $cta_pagar['compra_cond']; ?></td>
                                                        <td class="text-center"><?php echo $cta_pagar['cta_vence']; ?></td>                                     
                                                        <td class="text-center"><?php echo number_format($cta_pagar['cta_importe'], 0, ',', '.'); ?></td>
                                                        <td class="text-center"><?php echo $cta_pagar['cta_nro_cuota']; ?></td>
