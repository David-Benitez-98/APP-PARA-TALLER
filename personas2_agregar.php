                ...
                <div class="row">
                    <div class="col-lg-12">                                         
                        <div class="panel-body">
                            <form action="personas2_control.php" method="post"
                                  role="form" class="form-horizontal">
                                <input type="hidden" name="accion" value="1">
                                <input type="hidden" name="vper" value="0">
                                <input type="hidden" name="pagina" value="persona2_index.php">
                                <input type="hidden" id="fec_dia" name="vfec_dia" value="<?php echo date("Y-m-d")?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" required="" id="ci" autocomplete="off"
                                ...
                                <div class="form-group"> 
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" required="" id="nom"
                                               ...
                                               onblur="sololetras();"
                                               onkeyup="reemplazar();"
                                               onchange="reemplazar();" autocomplete="off"
                           ...
                           <div class="form-group" style="display: none" id="ocultarapellido">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" required="" id="dire" autocomplete="off"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="number" id="tel" 
                                               ...
                                               onchange="nronegativotel()" autofocus="">
...
<!--                                            <option value="">Seleccione</option>-->
                                 ...
                                 <div class="form-group">
                                    ...
                                    <?php $ciudades = consultas::get_datos("select * from ciudad_2 order by cod_ciu"); ?>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <?php
                                        $departamentos = consultas::get_datos("select * from departamento_2 "
                                                        . " order by cod_depar");
                                        ?>                                 
...
//function año1(){
//            var auxi1 = $("#check").attr('checked', true).val(); //radio button fisica
//            alert (auxi1);
//            //var hoy = new Date(); //fecha de hoy
//            var ano_actual = (new Date).getFullYear(); //año actual
//            var ano_nacimiento = (new Date($('#fec').val())).getFullYear(); //año de nacimiento
