    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <h3 class="page-header">Listado - Recepcion de Solicitudes
                            ...
                            <a href="recepcion_servicio2_agregar.php"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-success">
                            ...
                            <?php
                            $recepciones = consultas::get_datos("select * from v_recepcion_2 where cod_suc=".$_SESSION['cod_suc']. "
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="imprimir_recepcion.php?codigo=<?php echo $recepcion['cod_recep']; ?>"
                                                                ...
                                                                <a  
                                                                    href="recepcion_servicio2_agregar.php?codigo=<?php echo $recepcion['cod_recep']; ?>"
        ...
        <script>
            ...
            function anular(datos) {
                ...
                $('#si').attr('href'
                , 'recepcion_servicio2_control.php?codigo=' + dat[0] + 
                        '&vdescri=null' +
                        '&vfecha=1900-01-01'+
                        '&vestado=ANULADO'+
                        '&vusu=null' +
                        ...
                        '&vcli=null'+
                        '&accion=2'+
                        '&pagina=recepcion_servicio2_index.php');
