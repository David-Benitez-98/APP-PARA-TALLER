    ...
    <div class="col-md-6 col-md-offset-0">
        <div class="list-group">
            <a href="#" class="list-group-item active">
                Informes de Orden Diagnostico de Vehiculos 
            </a>              
        </div>   
        <div class="form-group col-md-12">
            <label class="col-sm-2 control-label">Usuario:</label>
            <div class="col-sm-6">
                <?php $usuarios = consultas::get_datos("select * from v_usuarios_2 order by cod_usu"); ?>                                                                 
...
<script>
    function enviar() {
        window.open("/mauro/imprimir_diagnostico_servicios.php?vusu=" + $('#vusu').val() + 
                '&vop=' + $('#op').val(), '_blank');
    }
</script>
