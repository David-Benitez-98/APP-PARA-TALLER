    ...
    <body>
        <div id="wrapper">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <h3 class="page-header">Registar Detalles del Diagnostico
                            <a href="diagnostico_servicio2_index.php" 
            ...
            <!--                Aqui Termina la Estructura Cabecera-->
                    ...
                    ("select * from v_deta_diagnostico where cod_diagnostico=" . $_REQUEST['vdiag'] . " order by cod_vehiculo asc");?>
                    <?php } ?>
                <div class="col-lg-12">
                        ...
                        <div class="panel panel-success">
                                        ...
                                        <tbody>
                                            <?php foreach ($detdiagnosticos as $detdiagnostico) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $detdiagnostico['datos_vehiculo']; ?></td>
                                                    ...
                                                    <td>
                                                       ...
                                                       <?php }else {?>
                                                        ...
                                                        $detdiagnostico['cod_vehiculo'] . "_" .     
                                                        $detdiagnostico['modelo'] . "_" .
                                                        $_REQUEST ['vrecep']. "'"
                                                        ?>);"
                         ...
                         <?php  if (isset($diagnosticos[0]['cod_recep'])) { ?>
                                        <?php $detarecepciones = consultas::get_datos(" select * from v_deta_recep_2 "
                                                        . " where estado='PENDIENTE' and cod_recep = " . $_REQUEST['vrecep']. " order by cod_vehiculo asc "); ?>  
                                    ...
                                    <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <?php foreach ($detarecepciones as $detarecepcion) { ?> 
                                                    <tr>
                                                    <td class="text-center"><?php echo $detarecepcion['cod_vehiculo']; ?></td>
                                                    ...
                                                    <td class="text-center"><?php echo $detarecepcion['modelo']; ?></td>
...
<!--                                    <input type="hidden"  id="articuloinvisible" name="articuloinvisible" value="">-->
                                   ...
                                   <div class="col-md-9"> 
                                    <label class="col-md-1 control-label"><h3>VEHICULO:</h3></label>
...
<!--                                    <input type="hidden" name="vequi" id="equi_otro" value="">-->
                ...
                <?php      if($diagnosticos[0]['estado']=='ANULADO' || $diagnosticos[0]['estado']=='CONFIRMADO' || $diagnosticos[0]['estado']=='PRESUPUESTADO' ||$diagnosticos[0]['cod_suc'] != $_SESSION['cod_suc']) {?>
                            ...
                            <div class="form-group">
                                   ...
                                   <div class="col-md-6"> 
                                         <?php  if (isset($diagnosticos[0]['cod_recep'])) { ?>
                                       <?php $equipos = consultas::get_datos("select * from v_deta_recep_2 "
                                            . " where cod_recep = " . $_REQUEST['vrecep']. " order by cod_vehiculo asc "); ?> 
