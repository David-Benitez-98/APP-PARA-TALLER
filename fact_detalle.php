                                        ...
                                        <tbody class="buscar">
                                            <?php foreach ($detapresus as $detapresu) { ?> 
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?php echo $detapresu['dat_vehi']; ?></td>
            ...
            <script>
                $("document").ready(function () {
                    ...
                    if (parseInt($('#depo').val()) > 0) {
                        $.ajax({
                            type: "GET",
                            url: "/mauro/lista_articulos_fact.php?vdepo=" + 
                                    $('#depo').val (),
                            cache: false,
                            beforeSend: function () {
                                $('#detayes').
...
//                    var dat = $('#artic').val().split("_");
                    if (parseInt($('#artic').val()) > 0) {
                        $.ajax({
                            type: "GET",
                            url: "/mauro/lista_precios_fact.php?varti=" + $('#artic').val ()+ '&vdepo=' +
                                    $('#depo').val (),
                            cache: false,
                            beforeSend: function () {
                                $('#precioo').
...
//                    var dat = $('#artic').val().split("_");
                    if (parseInt($('#artic').val()) > 0) {
                        $.ajax({
                            type: "GET",
                            url: "/mauro/lista_plazo_garantia_fac.php?varti=" + $('#artic').val ()+ '&vdepo=' +
                                    $('#depo').val (),
                            cache: false,
                            beforeSend: function () {
                                $('#plazo').
...
//                    var dat = $('#artic').val().split("_");
                    if (parseInt($('#artic').val()) > 0) {
                        $.ajax({
                            type: "GET",
                            url: "/mauro/lista_descri_garantia_fac.php?varti=" + $('#artic').val ()+ '&vdepo=' +
                                    $('#depo').val (),
                            cache: false,
                            beforeSend: function () {
                                $('#descri_garan').
...
//                    var dat = $('#artic').val().split("_");
                    if (parseInt($('#artic').val()) > 0) {
                        $.ajax({
                            type: "GET",
                            url: "/mauro/lista_condicion_garantia.php?varti=" + $('#artic').val ()+ '&vdepo=' +
                                    $('#depo').val (),
                            cache: false,
                            beforeSend: function () {
                                $('#condicion').
