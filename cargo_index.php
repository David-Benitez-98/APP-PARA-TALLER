        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header">LISTADO DE CARGO
                                        ...
                                        <table id="example1" width="100%" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($cargos as $cargo) { ?> 
                                                    <tr>
                                                        <td class="text-center"><?php echo $cargo['cod_cargo']; ?></td>
                                                        <td class="text-center"><?php echo $cargo['descrip_cargo']; ?></td>
                                                        <td class="text-center">
                                                            <a onclick="editar(<?php echo "'" . $cargo['cod_cargo'] . "_" .
                                                                    $cargo['descrip_cargo'] . "'"; ?>)" 
                                                               class="btn btn-xs btn-primary" rel='tooltip' data-title="Editar" 
                                                               data-toggle="modal" data-target="#editar">
                                                                <span class="glyphicon glyphicon-pencil"></span></a>
                                                            <a onclick="borrar(<?php echo "'" . $cargo['cod_cargo'] . "_" . 
                                                                    $cargo['descrip_cargo'] . "'"; ?>)" 
                        ...
                        <div class="modal-content">
                            ...
                            <form action="cargo_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="panel-body se">
                                    ...
                                    <input type="hidden" name="vcod_car" value="0"/> 
                                    <input type="hidden" name="pagina" value="cargo_index.php">

                                    <label class="col-lg-2 control-label">Descripción:</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="vcar_descrip" id="car" onchange="sololetras()" onkeyup="sololetras()"
                    ...
                    <div class="modal-content">
                        ...
                        <form action="cargo_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                            <div class="panel-body">
                                ...
                                <input type="hidden" name="pagina" value="cargo_index.php">
                                <input id="cod" type="hidden" name="vcod_car"/>
                                <label class="col-lg-2 control-label">Descripción:</label>
                                <div class="col-lg-10">
                                    <input id="descri" type="text" class="form-control" name="vcar_descrip" onchange="sololetraseditar()" onkeyup="sololetraseditar()"
                                           required=""  pattern="[a-z ]{5,20}"title="Solo letras!!!" autofocus="">
                                </div>
                                <br>
                            </div>
...
//                      var numero = trim(numero);
                var numero = document.getElementById("car").value;
...
//                      var numero = trim(numero);
            ...
            function borrar(datos) {
                var dat = datos.split("_");
                $('#si').attr('href', 'cargo_control.php?vcod_car=' + dat[0] + '&vcar_descrip=' + dat[1]
                        + '&accion=3&pagina=cargo_index.php');
