        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <h3 class="page-header text-center">Registar Detalles Orden de Trabajo
                            <a href="orden_trabajo_serv_index.php" 
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class=" panel panel-success">
                            ...
                            <div class="panel-heading">
                                Datos Cabecera Orden de Trabajo 
                             </div> 
                            <!-- /.panel-heading -->
                            
                            <?php  if (isset($_REQUEST['vorden_trab'])) { ?>
                         <?php    $ordentrabajos = consultas::get_datos("select * from v_orden_trabajo where cod_orden_trabajo=".$_REQUEST['vorden_trab']); ?>
                             <?php } ?>
...
<!--                                                <th class="text-center">Acción</th>-->
                                            ...
                                            <tbody>
                                                <?php foreach ($detpresupuestoservicios as $detpresupuestoservicio) { ?> 
                                                    ...
                                                    <td class="text-center"><?php echo $detpresupuestoservicio['modelo']; ?></td>
                                                    ...
                                                    <td class="text-center"><?php echo $detpresupuestoservicio['estado']; ?></td>
                                                     <td class="text-center">
                                                      ...
                                                      <?php   if ($detpresupuestoservicio['estado']=='CONFIRMADO' ||  $ordentrabajos[0]['estado']=='CONFIRMADO' 
                                                              || $ordentrabajos[0]['estado']=='ANULADO' || $ordentrabajos[0]['estado']=='EN INSUMO' 
                                                              || $ordentrabajos[0]['estado']=='TERMINADO' ){
                                                          
                                                      } else { ?>
                                                     <a onclick="diag_confirma(<?php
                                                        echo "'" . $detpresupuestoservicio['cod_presu_servi'] . "_" .
                                                        $detpresupuestoservicio['cod_tipo_servi'] . "_" .
                                                        $detpresupuestoservicio['cod_vehiculo'] . "_" .
                                                        $detpresupuestoservicio['cod_art'] . "_" .
                                                        $detpresupuestoservicio['cantidad_arti'] . "_" .
                                                        $detpresupuestoservicio['subtotal'] . "_" .
                                                        $detpresupuestoservicio['precio'] . "_" .
                                                        $detpresupuestoservicio['cod_dep'] . "_" .
                                                        $detpresupuestoservicio['monto_servi'] . "_" .
                                                        $detpresupuestoservicio['desc_promo_servi'] . "'";
                                                        ?>)" 
                        ...
                        <div class="modal-content">
                            ...
                            <form action="orden_trabajo_serv_control_deta.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="panel-body">
                                    ...
                                    <?php $funcionarios = consultas::get_datos("select * from v_funcionario_2 where cod_suc = ".$_SESSION['cod_suc']. " and cod_carg_2 = 1 order by cod_fun asc"); ?>
...
<!--                                        <option value="0">Seleccione un Articulo</option>-->
                                   ...
                                   <div class="col-md-5">
                                    ...
                                    <?php $equipos = consultas::get_datos("select * from v_vehiculo_2 order by cod_vehiculo asc"); ?>
...
<!--                                        <option value="0">Seleccione un Articulo</option>-->
                                        ...
                                        if (!empty($equipos)) {
                                            foreach ($equipos as $equipo) {
                                                ?>  
                                                <option value="<?php echo $equipo['cod_vehiculo']; ?>">
                                                    <?php echo $equipo['datos_vehiculo']; ?>
                                                </option>
                                                <?php
                                            }
                                        } else {
                                    ...
                                    <?php $articulos = consultas::get_datos("select * from v_articulos_3 where cod_tipo_arti = 1 OR cod_tipo_arti = 1 OR cod_tipo_arti = 1 order by cod_art asc"); ?>
