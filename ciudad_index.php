        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h3 class="page-header">LISTADO DE CIUDAD
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <?php
                            $ciudades = consultas::get_datos("select * from ciudad 
                                        ...
                                        <table id="example1" width="100%" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($ciudades as $ciudad) { ?> 
                                                    <tr>
                                                        <td class="text-center"><?php echo $ciudad['cod_ciudad']; ?></td>
                                                        <td class="text-center"><?php echo $ciudad['ciu_descrip']; ?></td>
                                                        <td class="text-center">
                                                            <a onclick="editar(<?php echo "'" . $ciudad['cod_ciudad'] . "_" .
                                                                    $ciudad['ciu_descrip'] . "'"; ?>)" 
                                                               class="btn btn-xs btn-primary" rel='tooltip' data-title="Editar" 
                                                               data-toggle="modal" data-target="#editar">
                                                                <span class="glyphicon glyphicon-pencil"></span></a>
                                                            <a onclick="borrar(<?php echo "'" . $ciudad['cod_ciudad'] . "_" . 
                                                                    $ciudad['ciu_descrip'] . "'"; ?>)" 
                        ...
                        <div class="modal-content">
                            ...
                            <form action="ciudad_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="panel-body se">
                                    ...
                                    <input type="hidden" name="vcod_ciu" value="0"/> 
                                    <input type="hidden" name="pagina" value="ciudad_index.php">

                                    <label class="col-lg-2 control-label">Descripción:</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" name="vciu_descrip" id="ciu" onchange="sololetras()" onkeyup="sololetras()"
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" 
                                    data-dismiss="modal" arial-label="Close">x</button>
                            <h4 class="modal-title"><strong>Editar Ciudad</strong></h4>
                        </div>
                        <form action="ciudad_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                            <div class="panel-body">
                                <input name="accion" value="2" type="hidden"/>
                                <input type="hidden" name="pagina" value="ciudad_index.php">
                                <input id="cod" type="hidden" name="vcod_ciu"/>
                                <label class="col-lg-2 control-label">Descripción:</label>
                                <div class="col-lg-10">
                                    <input id="descri" type="text" class="form-control" name="vciu_descrip" onchange="sololetraseditar()" onkeyup="sololetraseditar()"
                                           required=""  pattern="[a-z ]{5,20}"title="Solo letras!!!" autofocus="">
                                </div>
                                <br>
                            </div>
...
//                      var numero = trim(numero);
            ...
            function borrar(datos) {
                var dat = datos.split("_");
                $('#si').attr('href', 'ciudad_control.php?vcod_ciu=' + dat[0] + '&vciu_descrip=' + dat[1]
                        + '&accion=3&pagina=ciudad_index.php');
