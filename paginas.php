    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">PERMISO DE USUARIO
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               Grupo: <i><strong><?php echo $_REQUEST['vnombre']; ?>
                                    </strong></i>
                            </div>
                            <?php $paginas = consultas::get_datos
                                    ("select * from v_permisos "
                                    . " where cod_grupo=" . $_REQUEST['vgrup']); ?>
                    ...
                    <div class="panel-body">
                        <form action="paginas_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                            <div class="panel-body se">
                                ...
                                <input type="hidden" name="vnombre" value="<?php echo $_REQUEST['vnombre'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="grupo" 
                                               value="<?php echo $_REQUEST['vnombre'] ?>" readonly=""/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">Permisos</label>
                                    <div class="col-lg-6">
                                        <?php $permisos = consultas::get_datos("select * from paginas where cod_pag not in (select cod_pag from permisos where cod_grupo=" . $_REQUEST['vgrup'] . ")"); ?>                                 
                                        <select name="vpag" class="form-control">
                                            <?php
                                            if (!empty($permisos)) {
                                                foreach ($permisos as $permiso) {
                                                    ?>
                                                    <option value="<?php echo $permiso['cod_pag']; ?>"><?php echo $permiso['pag_nombre']; ?></option>
                                                    <?php
                                                }
                                            } else {
                                                ?>
                                        ...
                                        <div class="col-lg-9">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input type="checkbox"checked="" value="true" name="consul" id="PermisoConsul">
                                                    Consultar
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input type="checkbox" checked="" value="true" name="agre" id="PermisoAgre">
                                                    Insertar
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input type="checkbox" checked="" value="true" name="editar" id="PermisoConsul">
                                                    Actualizar
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <input type="checkbox" checked="" value="true" name="borrar" id="PermisoAgre">
                                                    Borrar
                                                </label>
                                            </div>
                                        </div>                               
        ...
        <div class="modal fade" id="editar"
             ...
             arial-labelledby="edit" aria-hidden="true">
            <div class=" modal-dialog">
...
<!--        <div class="modal fade" id="agregar" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content" id="detalles">
    ...
    <script>
        function editpag(datos) {
            ...
            $.ajax({
                type: "GET",
                url: "/mauro/paginas_editar.php?vgru=" + dat[0] + "&vpag=" + dat[1] + "&vnombre=" + dat[2] + "&vpagina=" + dat[3],
                cache: false,
                beforeSend: function () {
                    $('#detalles').html('<img src="/mauro/img/ajax-loader.GIF">  <strong><i>Cargando...</i></strong>');
                },
