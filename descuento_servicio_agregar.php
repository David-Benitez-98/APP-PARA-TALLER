        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <h3 class="page-header">Registar Descuentos de Servicios
                            <a href="descuento_servicio_index.php" 
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class=" panel panel-success">
                            ...
                            <div class="panel-heading">
                                Datos Cabecera Descuento 
                             </div> 
                                <div class="panel-body">
                             
                            <?php  if (isset($_REQUEST['codigo'])) { ?>
                            <?php  $descuentos =  consultas::get_datos("select * from v_descuento_servi where cod_desc_servi=".$_REQUEST['codigo']);?>
                            <?php } ?>
                              
                                    <form action="descuento_servicio_control.php" method="post" 
                                      role="form" class="form-horizontal">
                                    <input type="hidden" name="accion" id="accion" value="1">
                                    <input type="hidden" name="vdescuen" id="vdescuen" value="0">
                                    ...
                                    <input type="hidden" name="pagina" value="descuento_servicio_index.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="date" required="" id="vfecha_ini"
                                                   ...
                                                   value="<?= !empty($descuentos[0]['fecha_ini']) ? $descuentos[0]['fecha_ini'] : date("Y-m-d"); ?>"
                                                   <?= !empty($descuentos[0]['fecha_ini']) ? 'readonly' : '' ?>>
                                        ...
                                        <div class="col-md-3">
                                            <input type="date" required="" id="vfecha_fin" 
                                                   ...
                                                   value="<?= !empty($descuentos[0]['fecha_fin']) ? $descuentos[0]['fecha_fin'] : date("Y-m-d"); ?>"
                                                   <?= !empty($descuentos[0]['fecha_fin']) ? 'readonly' : '' ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-md-1 control-label">Funcionario:</label>
                                        <div class="col-md-4">
                                            <input type="text" required="" placeholder="Ingrese Sucursal" readonly="" 
                                                   class="form-control" value="<?= !empty($descuentos[0]['suc_descri']) ? $descuentos[0]['suc_descri'] : $_SESSION['suc_descri']; ?>">
...
<!-- COMIENZO PARA EL DETALLE AQUI VA UNA TABLA PARA AGREGAR EL DETALLE-->
 <!-- /.col-lg-12 -->
                ...
                <?php  if (isset($_REQUEST['codigo'])) { ?>
                <?php  $detadescuentos =  consultas::get_datos("select * from v_deta_descuento_servi where cod_desc_servi=".$_REQUEST['codigo']);?>
                <?php } ?>
 
                <div class="col-lg-12">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            Detalle Descuento de Servicios
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
...
<!--                                    Titulos de la Tabla-->
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="<?= isset($detadescuentos) ? 'display : none' : '' ?> ">
...
<!--                                        //sector nuevo para poder consultar si posee un detalle
                                    ...
                                    <?php   
//                                    $total = 0;
                                    if(isset($detadescuentos) && count($detadescuentos)>0 ){
                                                foreach ($detadescuentos as $value){ 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <input class="form-control text-center det-cant" type="text"  
                                                                   value="<?= isset($value['valor_porc_desc']) ? $value['valor_porc_desc'] : ''  ?>"
                                                                   name="det_valor_porcentual[]" id="detalle_valor_porcentual" style="text-align: center ; width: 200px" readonly="">
                                                        </td>
                                                        <td class="text-center">
                                                            <input class="form-control text-center det-cant" type="text"  
                                                                   value="<?= isset($value['descuento_servi']) ? $value['descuento_servi'] : ''  ?>"
                        ...
                        <div class="modal-content">
                            ...
                            <form action="tipo_servicio_control.php" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="panel-body se">
                                    ...
                                    <input type="hidden" name="pagina" value="descuento_servicio_agregar.php">
...
<!--                El hr es para poner una linea divisora-->
                <hr>
             <?php    if(!isset($detadescuentos)){?>
                     <div class="form-group">
                        <div class="col-md-offset-5 col-md-10">
                         <button type="button" id="grabar" onclick="grabar()" type="submit" class="btn-outline btn-primary btn-lg fa fa-floppy-o"> Grabar Descuento</button>
          ...
          function typeaheadInit(el, url, defaultValue){
                $(el).typeahead(null, {
                    source: new Bloodhound({
                        remote: {
                            url: '/mauro/lista_tipos_servicio.php',
...
//                       
//                        $.ajax({
//                            url: '/servitech_tesis/descuento_servicio_control.php',
//                            type: "POST",
////                            dataType: 'json',
//                            data: {
//                                detalles: TableData,
//                                vdescuen: $("#vdescuen").val(),
...
//                                 setTimeout(function () {
//                                          window.location.href = "./descuento_servicio_index.php";
//                                      }, 3000);
//                                 
//                            }else{
//                                notificacion("Atencion","El Tipo de Servicio ya esta Activo o Pendiente en otro descuento", "error");
//                                 setTimeout(function () {
//                                          window.location.href = "./descuento_servicio_index.php";
//                                      }, 3000);
//                                }
...
//                       });
                        if (TableData.length !== 0) {
                                $.ajax({
                            url: "/mauro/descuento_servicio_control.php",
                            method: "POST",
                            data: {
                                detalles: TableData,
                                vdescuen: $("#vdescuen").val(),
...
//                                if (data.error) {
//                                     
//                                   notificacion("Atencion", "El tipo de servicio ya existe...","error");
//                                    setTimeout(function() { 
//                                       window.location.href = "./descuento_servicio_index.php";
//                                    }, 2000);
//                                } else{
...
//                                } 
                            ...
                            error: function (xhr) {
                                notificacion("Atencion", "Error en el proceso de grabado del descuento", "error");
                            }
                            
                        });
                    } else {
                        notificacion("Atencion", "Debe completar los campos del detalle, no ingrese valores negativos", "error");
                      // document.getElementById("valor_porcentual_detalle").value = '';
                    }
                }
