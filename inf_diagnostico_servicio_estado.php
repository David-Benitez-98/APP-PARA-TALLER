    ...
    <div class="col-md-6 col-md-offset-0">
        <div class="list-group">
            <a href="#" class="list-group-item active">
                Informes de Diagnostico de Vehiculos
            </a>              
        </div>   
        <div class="form-group col-md-12">
            <label class="col-sm-5 control-label">Estado:</label>
            <div class="col-sm-6">
                <?php $compras = consultas::get_datos("select * from v_diagnostico  order by estado"); ?>                                                                 
...
<script>
    function enviar() {
        window.open("/mauro/imprimir_diagnostico_servicios.php?vesta=" + $('#vesta').val() + 
                '&vop=' + $('#op').val(), '_blank');
    }
</script>
