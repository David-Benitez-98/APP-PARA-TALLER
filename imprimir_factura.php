...
$sqlventas = "select *,(select numero_letras(total_comp)) "
        . "as total_letra "
      . " from v_comprasFACTURA where cod_compra = " . 
        $_REQUEST ['vdetcompra'] . "";
...
$pdf->Cell(85, 1, $rsventas[0]['provee_nomb'], 0, 0, 'C',null,1);
...
$pdf->Cell(100, 1, 'NRO.: ' . $rsventas[0]['fac_compra'], 0, 1, 'C');
...
$pdf->Cell(100, 1, 'TIMBRADO .: ' . $rsventas[0]['timb_nro'], 0, 1, 'C');
$pdf->Cell(100, 1, 'TELEFONO .: ' . $rsventas[0]['provee_tel'], 0, 0, 'C');
...
$pdf->Cell(/*1*/90, /*2*/1, /*3*/$rsventas[0]['fecha_comp_fac'], /*4*/0, /*5*/1, /*6*/'L', /*7*/null, /*8*/null, /*9*/1, /*10*/null, /*11*/null, /*12*/null);
$pdf->Ln(3);
//nombre cliente
$pdf->SetFont('Times', 'B', 10);
$pdf->Cell(30, 1, '   CLIENTE: ', 0, 0, 'L');
$pdf->SetFont('Times', '', 10);
$pdf->Cell(/*1*/90, /*2*/1, /*3*/'TALLER DE MOTOS MAURO', /*4*/0, /*5*/0, /*6*/'L', /*7*/null, /*8*/null, /*9*/1, /*10*/null, /*11*/null, /*12*/null);
...
$pdf->SetFont('Times', '', 10);
$pdf->Cell(/*1*/90, /*2*/1, /*3*/'RUTA 1 KM 17', /*4*/0, /*5*/0, /*6*/'L', /*7*/null, /*8*/null, /*9*/1, /*10*/null, /*11*/null, /*12*/null);
...
$pdf->SetFont('Times', '', 10);
$pdf->Cell(/*1*/37, /*2*/1, /*3*/'0986683696', /*4*/0, /*5*/0, /*6*/'L', /*7*/null, /*8*/null, /*9*/1, /*10*/null, /*11*/null, /*12*/null);
...
$consultas = "select * from v_compdetalle where cod_compra=".$_REQUEST ['vdetcompra'];
$detventas = consultas::get_datos($consultas);
if (!empty($detventas)) {
foreach ($detventas as $report) {
    $pdf->SetFont('Times', '', 10);
    $pdf->Cell(15, 1, $report['cod_arti'], 0, 0, 'C');
    $pdf->Cell(51, 1, /*3*/$report['arti_descrip'], 0, 0,'L',null,null,1,null,null,null);
...
$pdf->SetFont('Times', '', 10);
$pdf->Text(165, 243, 'Gs. '.
        number_format(($rsventas[0]['total_comp']),0,',','.'));
$pdf->SetFont('Times', 'B', 10);
