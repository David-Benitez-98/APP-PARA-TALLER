        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                         <h3 class="page-header">Libro iva Compras
                      </h3>
                    </div>     
                    <!--Buscador-->
                    <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <?php
                            $libros_compras = consultas::get_datos("SELECT * FROM v_ivacompra  
                            ORDER BY cod_iva_compra;");
                                ...
                                <div class="panel-body">
                                    <div>
                                        <table id="example1" width="100%" class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th class="text-center">N° Libro</th>                                        
...
<!--                                                    <th class="text-center">Acciones</th>-->
                                            ...
                                            <tbody class="buscar">
                                                <?php foreach ($libros_compras as $libro_compra) { ?> 
                                                    <tr>
                                                        <td class="text-center"><?php echo $libro_compra['cod_iva_compra']; ?></td>
                                                        <td class="text-center"><?php echo $libro_compra['cod_compra']; ?></td>
                                                        <td class="text-center"><?php echo $libro_compra['iva_fecha']; ?></td>
                                                        <td class="text-center"><?php echo $libro_compra['iva_nro_factura']; ?></td>
                                                         <td class="text-center"><?php echo number_format($libro_compra['total_exenta'], 0, ',', '.'); ?></td>
...
<!--                                                         <td class="text-center"><?php echo number_format($libro_compra['total_ivas'], 0, ',', '.'); ?></td>-->
                                                         <td class="text-center"><?php echo number_format($libro_compra['iva_total_compra'], 0, ',', '.'); ?></td>
                                                <td class="text-center"><?php echo $libro_compra['iva_estado']; ?></td>
